<x-app-layout>
  ...
  <div class="banner-category container-fluid" data-banner="fixed">
    <img src="{{asset('images/about-2025.webp')}}" alt="" class="banner-category__img fr-fic fr-dii">
    <div class="banner-category__box-title">
      <h1 class="banner-category__title">ABOUT US</h1>
    </div>
  </div>

  <div class="static-page__container bg-white">
      ...
      <img class="mt-4" src="{{asset('images/team.webp')}}" alt="">
  </div>
  @push('seo')
